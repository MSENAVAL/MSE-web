...
const CustomerProfile = () => {
    ...
    const handleUpdateCustomer = () => {
        navigate(`/customers/${id}/update`, { state: { customer } });
    };

    const mobileLayout = (
        <>
            <h1 className="text-bold ml-6 text-xl font-semibold text-primary-blue">Perfil do cliente</h1>
                    ...
                    <div className="flex w-full flex-col p-8">
                        <div className="mb-4 flex flex-row items-center">
                            ...
                            <div className="ml-4 w-full">
                                ...
                                <h2 className="ml-2 mt-[-6px]">{customer.nome}</h2>
                                <Badge
                                    className={`flex w-20 items-center rounded-full bg-opacity-35 p-0 ${customer.status ? "bg-[#8EC742] text-[#365B03] hover:bg-[#8EC742] hover:text-[#365B03]" : "bg-[#FB101E] text-[#790007] hover:bg-[#FB101E] hover:text-[#790007]"}`}
                                >
                        ...
                        <div className="mb-4 ml-20 mt-2 flex flex-col md:flex-row md:items-start md:justify-between">
                            <div className="flex flex-col md:w-1/3">
                                <label className="ml-2 text-sm text-gray-500">CNPJ</label>
                                <span className="ml-2">{customer.cnpj}</span>
                            </div>
                            <div className="mt-4 flex flex-col md:w-1/3">
                                <label className="ml-2 text-sm text-gray-500">Nome do representante</label>
                                <span className="ml-2">{customer.nomeRepresentante}</span>
                            </div>
                            <div className="mt-4 flex flex-col md:w-1/3">
                                <label className="ml-2 text-sm text-gray-500">Cargo</label>
                                <span className="ml-2">{customer.cargo}</span>
                            </div>
                            <div className="mt-4 flex flex-col md:w-1/3">
    ...
    return (
        <>
            <h1 className="text-bold ml-8 text-xl font-semibold text-primary-blue">Perfil do cliente</h1>
                ...
                <div className="xs:h-[90%] col-span-4 mb-8 flex h-[90%] w-[90%] flex-col rounded-2xl bg-[#F7F7F7] pr-0 sm:h-[90%] md:overflow-auto lg:pr-0 xl:h-[80%] xl:pr-24">
                    <div className="flex w-full flex-col p-8">
                        ...
                        <div className="mb-4 ml-20 mt-2 flex flex-col md:flex-row md:items-start md:justify-between">
                            <div className="flex flex-col md:w-1/3">
                                <label className="ml-2 text-sm text-gray-500">CNPJ</label>
                                <span className="ml-2">{cnpjMask(customer.cnpj)}</span>
                            </div>
                            <div className="flex flex-col md:w-1/3">
                                <label className="ml-2 text-sm text-gray-500">Nome do representante</label>
                                <span className="ml-2">{customer.nomeRepresentante}</span>
